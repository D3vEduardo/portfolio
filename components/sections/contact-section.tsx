...
export function ContactSection({ id }: ContactSectionProps) {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: Instagram,
      label: "Instagram",
      href: "https://instagram.com/eduardoaugustolb",
    ...
    },
    {
      ...
      icon: Twitter,
      label: "Twitter",
      href: "https://twitter.com/the_duh7",
    ...
    },
    {
      ...
      icon: Youtube,
      label: "YouTube",
      href: "https://youtube.com/@eduardo.developer",
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div>
                  ...
                  <AnimatedText
                    ...
                    text="eduardoaugustolimabueno@outlook.com.br"
                    wrapper="p"
                  />
                </div>
              </div>
              ...
              >
                <a
                  ...
                  href="mailto:eduardoaugustolimabueno@outlook.com.br"
